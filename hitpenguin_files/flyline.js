Main.flyLine = function(angle){
	...
	function initFlyLine() {  
		...
		flyRad = angleToRad(angle);
		 var flyData = {
			 images: ["./hitpenguin_files/fly.png"],
	...
	function addLongTrace(xPass, dif, timeC){
		longTracer = new createjs.Bitmap(Resource.get("./hitpenguin_files/longtraces.png"));
	...
	function addTrace(dif){
		var totalD = 0;
		var tracer = new createjs.Bitmap(Resource.get("./hitpenguin_files/traces.png"));
