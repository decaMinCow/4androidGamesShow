...
;~function(bt){
	...
	bt.URL = {
		root: "http://game.2sky.cn/"
		,getMoreGame: function(){
			// 点击更多
			bt.dc("more");
			
			return "http://game.2sky.cn/";
		}
		,getConcern: function(){
			return "http://mp.weixin.qq.com/s?__biz=MzA4ODkzNzUwMQ==&mid=200682354&idx=1&sn=f419363cb8cdeff6668ad20fe705716f#rd";
		}
		,appId: ""
	};
...
;~function(bt){
	...
	var loading = function(rate, error){
		if(rate > 0 && !loadingDiv){
			...
			loadingDiv.html('<table><tr><td><img class="bt-img" src="./hitpenguin_files/preloadImage.png" /><div class="bt-text"></div></td></tr></table>');
...
;~function(bt){
	...
	onlyH.prototype = {
		...
		,getScreenOption: function(){
			return {
				id: "bt-h-scrren"
				,html: "<table><tr><td><img class='bt-h-screen-img' src='./hitpenguin_files/bt-play-h-screen.png' /></td></tr></table>"
				,time: 0
				,lockId: 'bt-hide-lock'
			};
		}
	...
	onlyV.prototype = $.extend({}, onlyH.prototype, {
		...
		,getScreenOption: function(){
			return {
				id: "bt-v-scrren"
				,html: "<table><tr><td><img class='bt-v-screen-img' src='./hitpenguin_files/bt-play-v-screen.png' /></td></tr></table>"
				,time: 0
				,lockId: 'bt-hide-lock'
			};
		}
